...
while($row = $result->fetch_assoc()) { ?>
    ...
    <li><input type="button" value="<?php echo $row['quiz_name']; ?>"  onclick="location.href='http://localhost:234/proj/quiz_actions.php?quiz=<?php echo $row['quiz_name'];?>'"> </li>
    <?php } ?>
  </ul>
</nav>
<?php 
...
<article style="margin-left: 320px;
  ...
  <p>You can review previous quizzes using left panel or create new quiz using create buttton below.</p>
</article>
<br><br>
</div>
...
<div class="container fluid" >
  <input type="button" value="create" style="width:1000px;margin-left:30px; height:40px;background-color:#f4511e;text-color:Black;"onclick="location.href='http://localhost:234/proj/create_quiz.html';"><br><br>
</div>
<br><br><br>
